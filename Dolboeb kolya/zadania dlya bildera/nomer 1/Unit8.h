...
__published:	// IDE-managed Components
        ...
        void __fastcall Shape5ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall Shape6ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall Shape7ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall Shape8ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall Shape9ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        void __fastcall Shape10ContextPopup(TObject *Sender,
          TPoint &MousePos, bool &Handled);
        ...
        void __fastcall Shape5MouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall Shape6MouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall Shape7MouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall Shape8MouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall Shape9MouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
        void __fastcall Shape10MouseDown(TObject *Sender,
          TMouseButton Button, TShiftState Shift, int X, int Y);
